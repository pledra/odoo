...
class TestTracking(common.BaseFunctionalTest, common.MockEmails):
    ...
    def _assert_tracking(self, message, data):
        tracking_values = message.tracking_value_ids
    ...
    def setUp(self):
        ...
        self.record = self.env['mail.test.full'].sudo(self.user_employee).with_context({
    ...
    def test_message_track_template(self):
        ...
        self.assertEqual(self._mails[0]['body'], '<p>Hello Test2</p>')
