...
# from odoo.addons.mail.tests.common import assertEmails
...
class TestMessagePost(BaseFunctionalTest, MockEmails):
    ...
    # @assertEmails(recipients=[['partner_1'], ['partner_2'], ['partner_admin']], email_from='partner_employee')
    ...
    @mute_logger('odoo.addons.mail.models.mail_mail', 'odoo.models.unlink')
    # @assertEmails(recipients=[['partner_1']], email_from='partner_employee')
