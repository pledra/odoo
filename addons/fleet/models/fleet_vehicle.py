...
class FleetVehicle(models.Model):
    ...
    contract_count = fields.Integer(compute="_compute_count_all", string='# of Contracts')
    service_count = fields.Integer(compute="_compute_count_all", string='Services')
    fuel_logs_count = fields.Integer(compute="_compute_count_all", string='# of Fuel Logs')
