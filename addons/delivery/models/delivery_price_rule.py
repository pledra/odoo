...
class PriceRule(models.Model):
    ...
    variable = fields.Selection([('weight', 'Weight (kg)'), ('volume', 'Volume (L)'), ('wv', 'Weight (kg) * Volume (L)'), ('price', 'Price'), ('quantity', 'Quantity')], 'Variable', required=True, default='weight')
    operator = fields.Selection([('==', '='), ('<=', '<='), ('<', '<'), ('>=', '>='), ('>', '>')], 'Operator', required=True, default='<=')
    max_value = fields.Float('Maximum Value', required=True)
    variable_factor = fields.Selection([('weight', 'Weight (kg)'), ('volume', 'Volume (L)'), ('wv', 'Weight (kg) * Volume (L)'), ('price', 'Price'), ('quantity', 'Quantity')], 'Variable Factor', required=True, default='weight')
