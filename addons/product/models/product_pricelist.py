        ...
        for product, qty, partner in products_qty_partner:
            ...
            for rule in items:
                ...
                if rule.base == 'pricelist' and rule.base_pricelist_id:
                    ...
                    price = rule.base_pricelist_id.currency_id._convert_amount(price_tmp, self.currency_id, self.env.user.company_id, date, round=False)
                else:
            ...
            if suitable_rule and suitable_rule.compute_price != 'fixed' and suitable_rule.base != 'pricelist':
                price = product.currency_id._convert_amount(price, self.currency_id, self.env.user.company_id, date, round=False)
