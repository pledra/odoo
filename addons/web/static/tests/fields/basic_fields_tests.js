...
QUnit.module('basic_fields', {
    ...
    QUnit.test('monetary field with real monetary field in model', function (assert) {
        ...
        assert.strictEqual(form.$('.o_form_field_measure').html(), "$&nbsp;9.10",
            "readonly value should contain the currency");

        form.$buttons.find('.o_form_button_edit').click();

        assert.strictEqual(form.$('.o_form_field_measure > input').val(), "9.10",
        ...
        assert.strictEqual(form.$('.o_form_field_measure > input').length, 1,
        ...
        assert.strictEqual(form.$('.o_form_field_measure > span').html(), "€",
