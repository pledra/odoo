...
class ProductTemplate(models.Model):
    ...
    @api.multi
    def get_an_estimated_price(self, pricelist, qty=1, public=False, **kw):
        self.ensure_one()
        return self.product_variant_ids and self.product_variant_ids[0].get_an_estimated_price(pricelist, qty=qty, public=public) or 0
