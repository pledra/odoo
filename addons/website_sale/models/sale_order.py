...
class Website(models.Model):
    ...
    website_pricelist_ids = fields.One2many('product.pricelist', compute="_compute_pricelist_ids",
                                            string='Price list available for this Ecommerce/Website')

    @api.one
    def _compute_pricelist_ids(self):
        self.website_pricelist_ids = self.env["product.pricelist"].search(["|", ("website_id", "=", False), ("website_id", "=", self.id)])
