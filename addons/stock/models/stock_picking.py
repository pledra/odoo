...
class Picking(models.Model):
    ...
    package_ids = fields.One2many('stock.quant.package', compute='_compute_package_ids')
    package_detail_ids = fields.One2many('stock.quant.package', compute='_compute_package_ids')
    ...
    def _compute_package_ids(self):
        """ This compute method populate a one2Many containing all entire packages of the picking. """
        for picking in self:
