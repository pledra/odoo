...
class AccountAnalyticLine(models.Model):
    ...
    analytic_amount_currency = fields.Monetary(string='Amount Currency Analytic', compute="_get_analytic_amount_currency", help="The amount expressed in the related account currency if not equal to the company one.", readonly=True)
