...
class AccountInvoice(models.Model):
    ...
    def _compute_next_recurrency_date(self):
        for invoice in self.filtered(lambda inv: inv.state != 'draft' and inv.is_recurrency_enabled and inv.recurrency_interval and inv.recurrency_type):
    ...
    def _create_draft_record(self):
        ...
        inv.message_post(body=_('The document has been generated by <a href=# data-oe-model=account.invoice data-oe-id=%d>%s</a>') % (self.id, self.number))
