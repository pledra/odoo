...
class AccountInvoiceReport(models.Model):
    ...
    user_currency_price_total = fields.Float(string="Total Without Tax in User currency", compute='_compute_amounts_in_user_currency', digits=0)
    price_average = fields.Float(string='Average Price', readonly=True, group_operator="avg")
    user_currency_price_average = fields.Float(string="Average Price in User currency", compute='_compute_amounts_in_user_currency', digits=0)
