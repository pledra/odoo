...
class TestOee(TestMrpCommon):
    ...
    def test_wrokcenter_oee(self):
        ...
        # Need to computed before 15 days to set monday.
        date_before_15 = datetime.date.today() - datetime.timedelta(days=15)
        day = date_before_15 - datetime.timedelta(days=date_before_15.weekday())
